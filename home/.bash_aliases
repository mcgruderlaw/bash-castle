...
alias Agg='mux Agg'
alias am='alsamixer'
alias backup='sudo rsync -aAXv --progress --delete-before --exclude={"/dev/*","/proc/*","/sys/*","/tmp/*","/run/*","/mnt/*","/media/*","/lost+found","/var/lib/mpd/Music/*","/var/lib/transmission/Downloads/*","/home/*"} /* /media/Backup'
...
alias lpm='lpass login mcgruderlaw@gmail.com'
...
alias pw='gentoo-pipewire-launcher &'
alias r='ranger'
...
alias trw='watch transmission-remote -tactive -l'
alias t='tmux -2'
alias vb='virtualbox &'
